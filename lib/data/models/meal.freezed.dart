...
mixin _$Meal {
 ...
 int? get timestamp;// From meal history API
 List<String>? get youtubeSearchTerms;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Meal&&(identical(other.id, id) || other.id == id)&&(identical(other.mealName, mealName) || other.mealName == mealName)&&const DeepCollectionEquality().equals(other.totalEnergy, totalEnergy)&&(identical(other.ingredients, ingredients) || other.ingredients == ingredients)&&const DeepCollectionEquality().equals(other.groceries, groceries)&&const DeepCollectionEquality().equals(other.groceryNames, groceryNames)&&(identical(other.note, note) || other.note == note)&&(identical(other.rating, rating) || other.rating == rating)&&(identical(other.mealStatus, mealStatus) || other.mealStatus == mealStatus)&&(identical(other.userNote, userNote) || other.userNote == userNote)&&(identical(other.timestamp, timestamp) || other.timestamp == timestamp)&&const DeepCollectionEquality().equals(other.youtubeSearchTerms, youtubeSearchTerms));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,mealName,const DeepCollectionEquality().hash(totalEnergy),ingredients,const DeepCollectionEquality().hash(groceries),const DeepCollectionEquality().hash(groceryNames),note,rating,mealStatus,userNote,timestamp,const DeepCollectionEquality().hash(youtubeSearchTerms));

@override
String toString() {
  return 'Meal(id: $id, mealName: $mealName, totalEnergy: $totalEnergy, ingredients: $ingredients, groceries: $groceries, groceryNames: $groceryNames, note: $note, rating: $rating, mealStatus: $mealStatus, userNote: $userNote, timestamp: $timestamp, youtubeSearchTerms: $youtubeSearchTerms)';
}
...
@useResult
$Res call({
 int? id, String mealName, dynamic totalEnergy, String? ingredients, List<Grocery>? groceries, List<String>? groceryNames, String? note, double? rating, String? mealStatus, String? userNote, int? timestamp, List<String>? youtubeSearchTerms
});
...
/// Create a copy of Meal
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? mealName = null,Object? totalEnergy = freezed,Object? ingredients = freezed,Object? groceries = freezed,Object? groceryNames = freezed,Object? note = freezed,Object? rating = freezed,Object? mealStatus = freezed,Object? userNote = freezed,Object? timestamp = freezed,Object? youtubeSearchTerms = freezed,}) {
  return _then(_self.copyWith(
...
as int?,youtubeSearchTerms: freezed == youtubeSearchTerms ? _self.youtubeSearchTerms : youtubeSearchTerms // ignore: cast_nullable_to_non_nullable
as List<String>?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  String mealName,  dynamic totalEnergy,  String? ingredients,  List<Grocery>? groceries,  List<String>? groceryNames,  String? note,  double? rating,  String? mealStatus,  String? userNote,  int? timestamp,  List<String>? youtubeSearchTerms)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Meal() when $default != null:
return $default(_that.id,_that.mealName,_that.totalEnergy,_that.ingredients,_that.groceries,_that.groceryNames,_that.note,_that.rating,_that.mealStatus,_that.userNote,_that.timestamp,_that.youtubeSearchTerms);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id,  String mealName,  dynamic totalEnergy,  String? ingredients,  List<Grocery>? groceries,  List<String>? groceryNames,  String? note,  double? rating,  String? mealStatus,  String? userNote,  int? timestamp,  List<String>? youtubeSearchTerms)  $default,) {final _that = this;
switch (_that) {
case _Meal():
return $default(_that.id,_that.mealName,_that.totalEnergy,_that.ingredients,_that.groceries,_that.groceryNames,_that.note,_that.rating,_that.mealStatus,_that.userNote,_that.timestamp,_that.youtubeSearchTerms);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id,  String mealName,  dynamic totalEnergy,  String? ingredients,  List<Grocery>? groceries,  List<String>? groceryNames,  String? note,  double? rating,  String? mealStatus,  String? userNote,  int? timestamp,  List<String>? youtubeSearchTerms)?  $default,) {final _that = this;
switch (_that) {
case _Meal() when $default != null:
return $default(_that.id,_that.mealName,_that.totalEnergy,_that.ingredients,_that.groceries,_that.groceryNames,_that.note,_that.rating,_that.mealStatus,_that.userNote,_that.timestamp,_that.youtubeSearchTerms);case _:
  return null;
...
class _Meal implements Meal {
  const _Meal({this.id, required this.mealName, required this.totalEnergy, this.ingredients, final  List<Grocery>? groceries, final  List<String>? groceryNames, this.note, this.rating, this.mealStatus, this.userNote, this.timestamp, final  List<String>? youtubeSearchTerms}): _groceries = groceries,_groceryNames = groceryNames,_youtubeSearchTerms = youtubeSearchTerms;
...
@override List<String>? get youtubeSearchTerms {
  ...
  if (value == null) return null;
  if (_youtubeSearchTerms is EqualUnmodifiableListView) return _youtubeSearchTerms;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(value);
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Meal&&(identical(other.id, id) || other.id == id)&&(identical(other.mealName, mealName) || other.mealName == mealName)&&const DeepCollectionEquality().equals(other.totalEnergy, totalEnergy)&&(identical(other.ingredients, ingredients) || other.ingredients == ingredients)&&const DeepCollectionEquality().equals(other._groceries, _groceries)&&const DeepCollectionEquality().equals(other._groceryNames, _groceryNames)&&(identical(other.note, note) || other.note == note)&&(identical(other.rating, rating) || other.rating == rating)&&(identical(other.mealStatus, mealStatus) || other.mealStatus == mealStatus)&&(identical(other.userNote, userNote) || other.userNote == userNote)&&(identical(other.timestamp, timestamp) || other.timestamp == timestamp)&&const DeepCollectionEquality().equals(other._youtubeSearchTerms, _youtubeSearchTerms));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,mealName,const DeepCollectionEquality().hash(totalEnergy),ingredients,const DeepCollectionEquality().hash(_groceries),const DeepCollectionEquality().hash(_groceryNames),note,rating,mealStatus,userNote,timestamp,const DeepCollectionEquality().hash(_youtubeSearchTerms));
...
as String?,userNote: freezed == userNote ? _self.userNote : userNote // ignore: cast_nullable_to_non_nullable
as String?,timestamp: freezed == timestamp ? _self.timestamp : timestamp // ignore: cast_nullable_to_non_nullable
as int?,youtubeSearchTerms: freezed == youtubeSearchTerms ? _self._youtubeSearchTerms : youtubeSearchTerms // ignore: cast_nullable_to_non_nullable
as List<String>?,
  ));
}
