            ...
            children: [
              Row(
                ...
                children: [
                   ...
                   IconButton(onPressed: () => Navigator.of(context).pop(), icon: Icon(Icons.close, color: AppColors.textPrimary))
                ],
              ),
                        ...
                        children: [
                          ...
                          ...groceries.entries.map((e) => Padding(
                            ...
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Text('• ${e.key}', style: AppTextStyles.bodyLarge.copyWith(color: AppColors.textPrimary)),
